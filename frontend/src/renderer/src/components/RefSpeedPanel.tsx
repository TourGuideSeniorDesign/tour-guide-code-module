  ...
  return (
    <Card className="flex flex-col">
      <PanelHeader
        ...
        title="Ref Speed"
        badge={refSpeed ? <Badge variant="success">Live</Badge> : <Badge variant="secondary">No data</Badge>}
      />
      ...
      <CardContent>
        {refSpeed ? (
          ...
          <EmptyState isConnected={isConnected} topic="/ref_speed" className="h-24" />
        )}
      </CardContent>
    </Card>
  )
