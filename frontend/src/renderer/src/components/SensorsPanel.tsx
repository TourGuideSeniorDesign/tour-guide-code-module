import { Activity, Compass, Radar, Radio, Zap } from "lucide-react";
        ...
        {sensors ? (
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Section title="Ultrasonic" icon={<Radar className="h-3 w-3" />}>
              <DataRow
                label="Front 0"
                value={sensors.ultrasonic_front_0}
                unit="cm"
              />
              <DataRow
                label="Front 1"
                value={sensors.ultrasonic_front_1}
                unit="cm"
              />
              ...
              <DataRow
                label="Right"
                value={sensors.ultrasonic_right}
                unit="cm"
              />
            </Section>
            ...
            >
              <DataRow
                label="X"
                value={sensors.linear_acceleration_x.toFixed(3)}
                unit="m/s²"
              />
              <DataRow
                label="Y"
                value={sensors.linear_acceleration_y.toFixed(3)}
                unit="m/s²"
              />
              <DataRow
                label="Z"
                value={sensors.linear_acceleration_z.toFixed(3)}
                unit="m/s²"
              />
            </Section>
            ...
            >
              <DataRow
                label="X"
                value={sensors.angular_velocity_x.toFixed(3)}
                unit="rad/s"
              />
              <DataRow
                label="Y"
                value={sensors.angular_velocity_y.toFixed(3)}
                unit="rad/s"
              />
              <DataRow
                label="Z"
                value={sensors.angular_velocity_z.toFixed(3)}
                unit="rad/s"
              />
            </Section>
            ...
            >
              <DataRow
                label="X"
                value={sensors.magnetic_field_x.toFixed(3)}
                unit="µT"
              />
              <DataRow
                label="Y"
                value={sensors.magnetic_field_y.toFixed(3)}
                unit="µT"
              />
              <DataRow
                label="Z"
                value={sensors.magnetic_field_z.toFixed(3)}
                unit="µT"
              />
            </Section>
          </div>
